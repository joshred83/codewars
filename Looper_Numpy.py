...
You must write a function called looper which takes three
integers start, stop and number as input and returns a
list from start to stop with number total values in the list.
